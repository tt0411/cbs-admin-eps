  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: 'Project News',
        moreNews: 'More News',
        desc1: 'Soybean created the open source project cbs-admin on May 28, 2021!',
        desc2: 'Yanbowe submitted a bug to cbs-admin, the multi-tab bar will not adapt.',
        desc3: 'Soybean is ready to do sufficient preparation for the release of cbs-admin!',
        desc4: 'Soybean is busy writing project documentation for cbs-admin!',
