  ...
  page: {
    ...
    home: {
      ...
      projectNews: {
        title: '项目动态',
        moreNews: '更多动态',
        desc1: 'Cbs 在2021年5月28日创建了开源项目 cbs-admin!',
        desc2: 'Yanbowe 向 cbs-admin 提交了一个bug，多标签栏不会自适应。',
        desc3: 'Cbs 准备为 cbs-admin 的发布做充分的准备工作!',
        desc4: 'Cbs 正在忙于为cbs-admin写项目说明文档！',
        desc5: 'Cbs 刚才把工作台页面随便写了一些，凑合能看了！'
      },
      creativity: '创意'
    },
    function: {
